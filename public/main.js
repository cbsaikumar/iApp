...
var Fabricator = /** @class */ (function () {
    function Fabricator(fabricator, contact_name, email, phone, website, address) {
...
var FabricatorComponent = /** @class */ (function () {
    ...
    FabricatorComponent.prototype.ngOnInit = function () {
        this.fabricatorInfoForm = this.fb.group({
            fabricator: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
            contact_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"]('', [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required]),
...
var NewLeadComponent = /** @class */ (function () {
    ...
    NewLeadComponent.prototype.ngOnInit = function () {
        ...
        this.newLeadForm = this.fb.group({
            fabricatorInfoForm: this.fb.group({
                fabricator: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](),
                contact_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
            ...
            bidInfoForm: this.fb.group({
                ...
                document_received: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](''),
    ...
    NewLeadComponent.prototype.onChange = function (event) {
        ...
        this.selectedFabricator = this.fabricators.filter(function (element, index, array) {
            return element.fabricator === _this.selectedFabricatorName;
        });
        ...
        this.authService.getSalesDetails(bid_number).subscribe(function (data) {
            if (data) {
                ...
                _this.quoteInfoForm = _this.fb.group({
                    project_name: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.project_name),
                    main_steel_est_schedule: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](new Date(_this.salesDetails.main_steel_est_schedule).toISOString().substring(0, 10)),
                    main_steel_hours: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.main_steel_hours),
                    misc_steel_est_schedule: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](new Date(_this.salesDetails.misc_steel_est_schedule).toISOString().substring(0, 10)),
                    quote_price: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.quote_price),
                    engg_price: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.engg_price),
                    comments: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.comments),
                    misc_steel_hours: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.misc_steel_hours),
                    inclusion: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.inclusion),
                    exclusion: new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](_this.salesDetails.exclusion)
                });
        ...
        this.authService.getSalesDetails(bid_number).subscribe(function (data) {
            if (data) {
                ...
                _this.estimationInfoForm = _this.fb.group({
                    ...
                    main_steel_est_schedule: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](new Date(_this.salesDetails.main_steel_est_schedule).toISOString().substring(0, 10)),
                    main_steel_hours: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](_this.salesDetails.main_steel_hours),
                    misc_steel_est_schedule: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](new Date(_this.salesDetails.misc_steel_est_schedule).toISOString().substring(0, 10)),
