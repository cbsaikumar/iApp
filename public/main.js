        ...
        this.authService.getSalesDetails(this.bid_number).subscribe(function (data) {
            if (data) {
                ...
                _this.estimationInfoForm = _this.fb.group({
                    inclusions: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](_this.salesDetails.inclusion),
                    exclusions: new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"](_this.salesDetails.exclusion),
